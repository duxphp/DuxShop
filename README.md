...
<p align="center">
  <a href="https://github.com/duxphp/DuxShop">
    <img alt="maven" src="https://img.shields.io/badge/DuxShop-v1-blue.svg">
  </a>
...
DuxShop 是一款基于PHP/MYSQL开发的、专注于多种平台的基础化内容管理框架
...
- **多终端支持**：系统采用api多终端访问模式，便于多种用户需求，针对mvvm架与小程序、app等前端架构
...
[issues反馈](https://github.com/duxphp/DuxShop/issues)
